...
public final class SelfSignedCertGenerator {
    ...
    public static List<X509Certificate> generateCertificate(String dn) throws Exception {
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA");
        keyPairGenerator.initialize(2048);
        KeyPair keyPair = keyPairGenerator.generateKeyPair();

        List<X509Certificate> certificates = new ArrayList<>();
        certificates.add(SelfSignedCertGenerator.generate(keyPair, "SHA256withRSA", dn, KeyUsage.keyEncipherment, 730));
        certificates.add(SelfSignedCertGenerator.generate(keyPair, "SHA256withRSA", dn, KeyUsage.digitalSignature, 730));
        return certificates;
    }

    public static String getBase64EncodedCertificateAsString(X509Certificate certificate) throws IOException, CertificateEncodingException {

        // Get cert as byte array, base64 encode and return as a string
            ...
            throws OperatorCreationException, CertificateException, CertIOException
    {
        ...
        final X509v3CertificateBuilder certificateBuilder =
                new JcaX509v3CertificateBuilder(x500Name,
                        ...
                        x500Name,
                        keyPair.getPublic())
                        .addExtension(Extension.keyUsage, false, new KeyUsage(keyUsage))
                        .addExtension(Extension.subjectKeyIdentifier, false, createSubjectKeyId(keyPair.getPublic()))
                        //.addExtension(Extension.subjectAlternativeName, false, new GeneralNames(genNames.toArray(new GeneralName[0])))
